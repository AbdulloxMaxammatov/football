...
let arsenalElement = navbarList.children[0].children[0];

let teamName = document.querySelector("#teamName");

let mainList = document.querySelector(".main__list");
arsenalElement.onclick = () => getArsenalPlayer();

function getArsenalPlayer() {
    footer.children[0].innerHTML = "";
    footer.append(teamName);
    mainList.innerHTML = "";
    players.forEach((item, index) => {
        if (item.team == "Arsenal") {
            let liElement = document.createElement("li");
            let img = document.createElement("img");
            img.src = "https://picsum.photos/id/" + `${index}` + "/250/250";
            img.style = "max-width:100%";
            let firstName = document.createElement("p");
            firstName.innerHTML = item.first_name + " " + item.last_name;
            ...
            id.innerHTML = item.first_name + "<br>" + item.last_name + "<br>" + item.identifier;
            team.innerHTML = item.team;

            footer.children[0].append(id);
            liElement.append(img, firstName, position, team);
            mainList.append(liElement);
        }
    })
}

let manchesterCity = navbarList.children[1].children[0];
manchesterCity.onclick = () => getManCityPlayer();

function getManCityPlayer() {
    footer.children[0].innerHTML = "";
    footer.append(teamName);
    mainList.innerHTML = "";
    players.forEach((item, index) => {
        if (item.team == "Manchester City") {
            let liElement = document.createElement("li");
            let img = document.createElement("img");
            img.src = "https://picsum.photos/id/" + `${index}` + "/250/250";
            img.style = "max-width:100%";
...
let manchesterUnited = navbarList.children[2].children[0];
manchesterUnited.onclick = () => getManUnitedPlayer();

function getManUnitedPlayer() {
    footer.children[0].innerHTML = "";
    mainList.innerHTML = "";
    footer.append(teamName);
    players.forEach((item, index) => {
        if (item.team == "Manchester United") {
            let liElement = document.createElement("li");
            let img = document.createElement("img");
            img.src = "https://picsum.photos/id/" + `${index}` + "/250/250";
            img.style = "max-width:100%";
...
let totenham = navbarList.children[3].children[0];
totenham.onclick = () => getTotenhamPlayer();

function getTotenhamPlayer() {
    footer.children[0].innerHTML = "";
    mainList.innerHTML = "";
    footer.append(teamName);
    players.forEach((item, index) => {
        if (item.team == "Tottenham") {
            let liElement = document.createElement("li");
            let img = document.createElement("img");
            img.src = "https://picsum.photos/id/" + `${index}` + "/250/250";
            img.style = "max-width:100%";
...
let WestBrom = navbarList.children[4].children[0];
WestBrom.onclick = () => getWestBornPlayer();

function getWestBornPlayer() {
    footer.children[0].innerHTML = "";
    mainList.innerHTML = "";
    footer.append(teamName);
    players.forEach((item, index) => {
        if (item.team == "West Brom") {
            let liElement = document.createElement("li");
            let img = document.createElement("img");
            img.src = "https://picsum.photos/id/" + `${index}` + "/250/250";
            img.style = "max-width:100%";
...
let allTeam = navbarList.children[5].children[0];
allTeam.onclick = () => getAllPlayer();
